...
class BipedalWalker(gym.Env, EzPickle):
    ...
    def step(self, action: np.ndarray):
        ...
        # print("the x linear velocity is: ")
        # print(vel.x)
    ...
    def render(self):
        ...
        self.surf = pygame.Surface((VIEWPORT_W + max(0.0, self.scroll) * SCALE, VIEWPORT_H))
        ...
        pygame.draw.aaline(self.surf, color=(0, 0, 0), start_pos=(x, flagy1), end_pos=(x, flagy2))
        f = [
            (x, flagy2),
            (x, flagy2 - 10),
            (x + 25, flagy2 - 5),
        ...
        if self.render_mode == "human":
            ...
            return np.transpose(np.array(pygame.surfarray.pixels3d(self.surf)), axes=(1, 0, 2))[:, -VIEWPORT_W:]
